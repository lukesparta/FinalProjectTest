...
{
    [Binding]
    public class View_Cohort_Details_FeatureSteps
    {
        ...
        public void WhenIClickOnACohort()
        {
        ...
        public void ThenIWantToBeRedirectedToAPageWithTheCohortsDetailsAndInformation()
        {
