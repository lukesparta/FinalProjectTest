...
{
    [Binding]
    public class View_Specialisation_Details_FeatureSteps
    {
        IWebDriver driver = new ChromeDriver("C:/Sparta-IMS-Eng24");
        [Given(@"I am on the Specialisation page")]
        public void GivenIAmOnTheSpecialisationPage()
        {
        ...
        public void WhenIClickOnASpecialisationDetails()
        {
        ...
        public void ThenIWantToBeRedirectedToAPageWithTheSpecialisationsDetailsAndInformation()
        {
